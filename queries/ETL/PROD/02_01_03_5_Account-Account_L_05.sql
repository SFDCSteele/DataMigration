...
SELECT  --TOP 10000
    ...
    ,A.ShippingProvince__c
    ,A.ShippingLatitude
    ,A.ShippingLongitude

  INTO sfdc.Account_Account_L_05
FROM sfdc.Account_Location_T AS A
INNER JOIN sfdc.Id_Account_prod AS B -- verify this works on base load too!!!!!
ON A.AIMSAccount__c = B.AIMSACCOUNT__C AND a.PrimaryLocation__c = 'true'
WHERE B.RecordTypeId = @RecordTypeId
/*
