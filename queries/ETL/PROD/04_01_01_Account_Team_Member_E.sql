...
FROM oscall.ACCOUNT_SEED 
--FROM osc.ACCOUNT_SEED 
--FROM oscd.ACCOUNT_SEED 
where OrganizationDEO_ABFFreightCorporate_c != ''
...
FROM oscall.account_location_seed AS A
--FROM osc.account_location_seed AS A
--FROM oscd.account_location_seed AS A

Left JOIN oscall.account_seed AS B 
...
where B.OrganizationDEO_ABFFreightCorporate_c != ''
--    AND CorpEmplID__c = '00767509'
