...
LEFT OUTER JOIN sfdc.[Id_Account_fullData_230517-0925] AS B
...
LEFT OUTER JOIN sfdc.[Id_User_fullData_230516-1405] AS D
ON A.CreatedById = D.Alias AND D.CorpEmplID__c IS NOT NULL
LEFT OUTER JOIN sfdc.[Id_User_fullData_230516-1405] AS E
