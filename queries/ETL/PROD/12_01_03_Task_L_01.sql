...
LEFT JOIN sfdc.[Id_User_fullData_230516-1405] AS D2 -- for OwnerId
...
LEFT JOIN sfdc.[Id_Contact_fullData_230518-0928] AS E2 -- for contact
...
LEFT JOIN sfdc.[Id_Account_fullData_230518-1535] AS G-- for Account__c
