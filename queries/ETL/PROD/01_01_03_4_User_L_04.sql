...
--  ,A.Username -- test only
--  ,A.IsActive -- test only
...
ON A.MgrCorpEmplID__c = C.CorpEmplID__c AND C.CorpEmplID__c IS NOT NULL AND A.MgrCorpEmplID__c != ''
