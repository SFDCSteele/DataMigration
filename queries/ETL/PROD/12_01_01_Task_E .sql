...
SELECT ---TOP 1000--TOP 0.1 PERCENT
 ...
 INTO sfdc.Task_E
FROM oscall.activity_missing_seed 
--FROM oscall.ACTIVITY_SEED 
--FROM osc.ACTIVITY_SEED 
--FROM oscd.ACTIVITY_SEED 
    Where ActivityFunctionCode = 'TASK' 
            AND StatusCode <> 'CANCELED' 
            AND ( InternalType_c != 'CUSTOMER_CHURN' OR InternalType_c is null)
