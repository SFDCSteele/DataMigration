-- HealthCheck_T_UAT.sql HealthCheck target object view transformation query to table Account_Account_T
USE Salesforce
--  DROP TABLE sfdc.HealthCheck_T_UAT
...
--  INTO sfdc.HealthCheck_T_UAT
FROM sfdc.HealthCheck_E_UAT;
