--  Account-Account_L_02_U.sql Update delta load Account RT Account target object view load query to table Account_Account_L_02_U
...
--  INTO sfdc.Account_Account_L_02_U
--	DROP TABLE sfdc.Account_Account_L_02_U
...
/*
LEFT JOIN sfdc.[Id_Account_fullData_230518-1535] AS E -- for Parent Account.Id
ON TRIM(A.PAR_AIMS_ACCT__c) = TRIM(E.AIMSAccount__c) AND F.RecordTypeId = '@RecordTypeId'
*/
LEFT JOIN sfdc.[Id_Account_fullData_230518-1535] AS F -- for Account.Id
