-- Account-Location_L_02.sql Account RT Location target object view load query to table Account_Location_L_02
...
LEFT JOIN sfdc.[Id_Account_fullData_230517-0925] AS B-- for OwnerId, Account__c -- VERIFY SOURCE FRESHNESS !!!
...
LEFT JOIN sfdc.[Id_Account_fullData_230517-0925] AS F -- for Account-Location record Id values
